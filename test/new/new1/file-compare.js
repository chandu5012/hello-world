...
function handleFileCompareTypeChange(type) {
  ...
  const savedUnix = typeof saveUnixConfig === 'function' ? saveUnixConfig("filecompare") : null;
  ...
  if (typeof restoreUnixConfig === 'function') restoreUnixConfig("filecompare", savedUnix);
}
...
function executeFileCompareOperation(event) {
  ...
  const formData = {
    ...
    unixServer: {
      host: typeof resolveUnixHostValue === 'function' ? resolveUnixHostValue("filecompare") : (document.getElementById("filecompareUnixHost")?.value || ""),
      clusterType: typeof resolveClusterTypeValue === 'function' ? resolveClusterTypeValue("filecompare") : (document.getElementById("filecompareClusterType")?.value || "dpc"),
      userEmail: document.getElementById("filecompareUserEmail")?.value || "",
      batchId: document.getElementById("filecompareBatchId")?.value || "",
